...
{
    c.SwaggerDoc("v1", new OpenApiInfo { Title = "Apr0124", Version = "v1" });
...
//Inject context
builder.Services.AddTransient<Apr0124Context>();
...
if (app.Environment.IsDevelopment() || app.Environment.IsStaging() || app.Environment.IsProduction())
{
    ...
    app.UseSwaggerUI(c =>
    {
        c.SwaggerEndpoint("/swagger/v1/swagger.json", "Apr0124 API v1");
